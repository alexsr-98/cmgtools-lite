...
#        thedict[""].SetBinError(iB, 0)
    ...
    tru                        = giveMeOneComparisonNormalised(tmptfile.Get('x_bb4l'),                       "bb4l",                        scaleval, varName)
    twttbardr                  = giveMeOneComparisonNormalised(tmptfile.Get('x_twttbardr'),                  "twttbardr",                  scaleval, varName)
    twttbards                  = giveMeOneComparisonNormalised(tmptfile.Get('x_twttbards'),                  "twttbards",                  scaleval, varName)
    twttbarherwig              = giveMeOneComparisonNormalised(tmptfile.Get('x_twttbarherwig'),              "twttbarherwig",              scaleval, varName)
    twttbaramc_dr              = giveMeOneComparisonNormalised(tmptfile.Get('x_twttbaramc_dr'),              "twttbaramc_dr",              scaleval, varName)
    twttbaramc_dr2             = giveMeOneComparisonNormalised(tmptfile.Get('x_twttbaramc_dr2'),             "twttbaramc_dr2",             scaleval, varName)
    twttbaramc_ds              = giveMeOneComparisonNormalised(tmptfile.Get('x_twttbaramc_ds'),              "twttbaramc_ds",              scaleval, varName)
    twttbaramc_ds_runningBW    = giveMeOneComparisonNormalised(tmptfile.Get('x_twttbaramc_ds_runningBW'),    "twttbaramc_ds_runningBW",    scaleval, varName)
    #twttbaramc_ds_is           = giveMeOneComparisonNormalised(tmptfile.Get('x_twttbaramc_ds_is'),           "twttbaramc_ds_is",           scaleval, varName)
    #twttbaramc_ds_is_runningBW = giveMeOneComparisonNormalised(tmptfile.Get('x_twttbaramc_ds_runningBW'),    "twttbaramc_ds_is_runningBW", scaleval, varName)
