...
varList['Lep1Lep2_Pt'] = {
    ...
    "yaxismax_particlefidbin": 0.019,
    "yaxismax_ratio_fidbin"     : 1.5,
    'legpos_particlefidbin': (.47, .88, .74, .43),
}

varList['NJets'] = {
    'printname'      : 'Number of jets',
...
varList['NBJets'] = {
    ...
    'yaxis_unc'      : 'Relative uncertainty',
    'printname'      : '\\text{Number of b jets}',
