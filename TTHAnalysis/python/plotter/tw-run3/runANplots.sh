...
#python tw-run3/plotterHelper.py -P 2023-12-23 -y 2022PostEE -o $OUTDIR2 -r nojets-ee -q batch -j 16 -f
#python tw-run3/plotterHelper.py -P 2023-12-23 -y 2022PostEE -o $OUTDIR2 -r nojets-mm -q batch -j 16 -f
#
...
#python tw-run3/plotterHelper.py -P 2023-12-23 -y 2022 -o $OUTDIR2 -r nojets-ee -q batch -j 16 -f
#python tw-run3/plotterHelper.py -P 2023-12-23 -y 2022 -o $OUTDIR2 -r nojets-mm -q batch -j 16 -f
#
